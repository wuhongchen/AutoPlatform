          ...
          <template #default="{ row }">
            <el-button-group>
              ...
              <el-button
                ...
                size="small"
                plain
                @click="openMarkdownEditor(row.id)"
              >
                MD 编辑
              </el-button>
              <el-button
...
function openMarkdownEditor(articleId) {
  router.push({ name: 'MarkdownEditor', query: { articleId } })
}
...
.result-preview-panel { margin-top: 18px; }
...
.result-mobile-preview-shell { margin-top: 14px; }
.result-mobile-preview-screen { min-height: 680px; }
</style>
